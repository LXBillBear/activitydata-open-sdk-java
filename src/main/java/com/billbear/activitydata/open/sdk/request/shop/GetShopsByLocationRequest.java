 ...
 *
 */
public class GetShopsByLocationRequest extends BaseRequest<GetShopsByLocationResponse> {
	...
	@Override
	public Class<GetShopsByLocationResponse> getResponseClass() {
		return GetShopsByLocationResponse.class;
	}
